...
class CustomHeightSizedBox extends StatelessWidget {
  ...
  CustomHeightSizedBox({@required this.percentage});
  @override
  Widget build(BuildContext context) {
...
class CustomWidthSizedBox extends StatelessWidget {
  ...
  CustomWidthSizedBox({@required this.percentage});
  @override
  Widget build(BuildContext context) {
    double height = MediaQuery.of(context).size.height;
    double width = MediaQuery.of(context).size.width;
...
class CustomButton extends StatelessWidget {
  ...
  CustomButton(
      ...
      this.fontWieght: FontWeight.normal});
  @override
  Widget build(BuildContext context) {
    double height = MediaQuery.of(context).size.height;
    double width = MediaQuery.of(context).size.width;
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Center(
              ...
              text,
              style: TextStyle(
                  color: textColor, fontWeight: fontWieght, fontSize: fontSize),
            )),
            decoration: BoxDecoration(
                color: mainColor, borderRadius: BorderRadius.circular(radius)),
          ),
        ),
      ],
    );
